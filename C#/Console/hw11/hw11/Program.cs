...
namespace hw11
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Worker work1 = new Worker("aadwe", "", 18);
			Worker work2 = new Worker("adddsfasfcheck", "", 15);
			Worker work3 = new Worker("acheckqwe", "", 16);
			//listOfWorkers.Add(work1);
			//listOfWorkers.Add(work2);
			//listOfWorkers.Add(work3);
			string n;
			while (true)
			{
				Console.Clear();
